...
StartPoint::StartPoint(GLfloat x, GLfloat y, GLfloat size) {
	this->x = x;
	this->y = y;
	this->size = size;
}
...
void StartPoint::createGeometry(GLuint program) {
	GLfloat verts[] = {
		-size, size, 0.0f,
		-size, -size, 0.0f,
		size, -size, 0.0f,
...
void StartPoint::draw(GLuint program, glm::mat4 viewMat) {
